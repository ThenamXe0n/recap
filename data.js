...
let authorName = "rumi";
let selectedAuthorQuote = quotes.filter((item) => {
  return item.author.toLowerCase() === authorName.toLowerCase();
});
console.log(selectedAuthorQuote);

let numbers = [44, 3, 22, 11, 55, 5, 6, 666]; //[3,5,6,11,22,44,55,666]
// let ascNum = numbers.sort();
// console.log(ascNum)


//reduce 
let total = numbers.reduce((acc,curr)=>acc,)
console.log(total)
//  {
//     id: 2,
//     quote:
